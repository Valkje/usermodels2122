...
class BufferCondition {
	 ...
	 * 
	 * @param slot the slot
	 * @return the slot condition for that slot, or <tt>null</tt> if the slot is not
	 *         present
	 */
	 ...
	 * 
	 * @param slot the slot
	 * @returns <tt>true</tt> if the buffer condition specifies the slot in any slot
	 *          condition, and <tt>false</tt> otherwise
	 */
	 ...
	 * @returns <tt>true</tt> if the buffer condition specifies the slot value in
	 *          any slot condition, and <tt>false</tt> otherwise
	 */
	 ...
	 * <tt>!</tt> prefix.
	 * 
	 * @return <tt>true</tt> if the buffer condition is special, or <tt>false</tt>
	 *         otherwise
	 */
	...
	/**
	 * Gets a string representation of the first line of the buffer condition, with
	 * an instantiation if provided.
	 * 
	 * @return the string
	 */
