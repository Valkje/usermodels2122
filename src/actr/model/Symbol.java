...
public class Symbol {
	 ...
	 * 
	 * @param s the string
	 * @return the symbol for the string, or <tt>Symbol.nil</tt> if the string is
	 *         null
	 */
	 ...
	 * 
	 * @return <tt>true</tt> if the symbol represents a variable, or <tt>false</tt>
	 *         otherwise
	 */
	 ...
	 * 
	 * @return <tt>true</tt> if the symbol represents a number, or <tt>false</tt>
	 *         otherwise
	 */
	 ...
	 * (<tt>'"'</tt>).
	 * 
	 * @return <tt>true</tt> if the symbol represents a string, or <tt>false</tt>
	 *         otherwise
	 */
