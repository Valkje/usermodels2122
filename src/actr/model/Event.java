...
public abstract class Event implements Comparable<Event> {
	 ...
	 * 
	 * @return -1 if this event comes before the given event, +1 if it comes after
	 *         the given event, and 0 if the events are equal (which normally will
	 *         not occur due to the unique identifiers)
	 */
	...
	/**
	 * The abstract action method. This method should be implemented with the code
	 * to perform the desired action at the time of the event.
	 */
