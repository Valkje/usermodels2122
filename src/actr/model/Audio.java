...
public class Audio extends Module {
	...
	/**
	 * Adds an aural sound for access by the aural module. The identifier should be
	 * unique for different sounds; if the same identifier is used, the new sound
	 * will cancel the previously scheduled one.
	 * 
