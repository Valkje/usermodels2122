...
public class Statistics {
	...
	/**
	 * Computes the correlation of two two-dimensional arrays (by flattening them
	 * and then computing the correlation on the flattened arrays).
	 * 
	 * @param a1 the first array
	 * @param a2 the second array
	 * @return the correlation
	...
	/**
	 * Computes the RMSE of two two-dimensional arrays (by flattening them and then
	 * computing the RMSE on the flattened arrays).
	 * 
	 * @param a1 the first array
	 * @param a2 the second array
	 * @return the RMSE
	...
	/**
	 * Computes a normalized error of two arrays as the proportion of the RMSE to
	 * the mean.
	 * 
	...
	/**
	 * Computes a normalized error of two 2d arrays as the proportion of the RMSE to
	 * the mean.
	 * 
	 * @param model the model data
	 * @param human the human data
