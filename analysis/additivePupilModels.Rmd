...
plot_smooth(m1.1,view="Time",plot_all="condition",cond = list("Gaze_X"=960,
                                                            "Gaze_Y"=540))
...
plot_smooth(m1.2,view="Time",plot_all="condition",cond = list("Gaze_X"=960,
                                                               "Gaze_Y"=540))
# Model checks
hist(m1.2$residuals,
     xlab = "Residuals")
...
plot_smooth(m2.1,view="Time",plot_all="condition",cond = list("Gaze_X"=960,
                                                            "Gaze_Y"=540))
...
summary(m3.1)
plot(m3.1)
plot_smooth(m3.1,view="Time",cond = list("Gaze_X"=960,
                                       "Gaze_Y"=540))
